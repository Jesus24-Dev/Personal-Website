...
function NavbarListElements({linkTo, content}: NavbarListElementProps) {
    return (
        <li className="group relative active:scale-95 transition-transform font-bebas">
            <a 
                href={`#${linkTo}`}
                className=" text-white hover:text-lime-200 transition-colors duration-300 px-4 py-2 block relative font-semibold"
            >
                {content}
